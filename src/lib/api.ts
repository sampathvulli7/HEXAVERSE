...
• Key Priority & Infrastructure: Leadership explicitly emphasized during the All-Hands call that upgrading backend infrastructure scaling and keeping API latency under 50ms is our #1 technical priority [3].`,
        citations: [
          { id: 'c1', number: 1, fileId: 'f1', sourceFile: 'Q3_Earnings_Report.pdf', sourceType: 'pdf', topicName: 'Financial Performance', page: 'Page 4', snippet: 'Enterprise software revenue saw a robust 15% YoY growth, largely attributed to the successful adoption of our newly released AI analytics suite across top accounts.' },
