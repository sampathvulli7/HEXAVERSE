...
export function CommandBox({ onSearch, isChatMode, onFilesAttached }: CommandBoxProps) {
            ...
            <button 
              ...
              className={cn(
                ...
                (input.trim() || attachments.length > 0)
                  ? "bg-blue-600 dark:bg-blue-500 text-white shadow-md hover:bg-blue-700 dark:hover:bg-blue-600 hover:scale-105 active:scale-95" 
